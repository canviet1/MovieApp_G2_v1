...
import com.example.g2_movieapp.domain.Actor;
import com.example.g2_movieapp.helper.Constant;

import java.util.List;

public class ActorPopularAdapter extends RecyclerView.Adapter<ActorPopularAdapter.ActorViewHolder> {
    private List<Actor> actors;

    public ActorPopularAdapter(List<Actor> actors) {
        this.actors = actors;
    }
